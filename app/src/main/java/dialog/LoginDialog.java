...
public class LoginDialog extends DialogFragment {
    ...
    public void onLoginDialogLogin(String username, String password) {
        Call<UserTransfer> loginCall = RestApi.getHaruueKnowWebApiService().login(username, password);
    ...
    public void onLoginDialogRegister(final String username, final String password) {
        Call<InformationTransfer> loginCall = RestApi.getHaruueKnowWebApiService().register(username, password);
